  ...
  int main(int argc, char *argv[]) {
    ...
    TYPE_T *A, *B, *C_fpga;
    posix_memalign((void **)&A, IntelFPGAOCLUtils::AOCL_ALIGNMENT, N*K*sizeof(TYPE_T));
    posix_memalign((void **)&B, IntelFPGAOCLUtils::AOCL_ALIGNMENT, K*M*sizeof(TYPE_T));
    posix_memalign((void **)&C_fpga, IntelFPGAOCLUtils::AOCL_ALIGNMENT, N*M*sizeof(TYPE_T));
    ...
    //get data back
    queues[0].enqueueReadBuffer(C_buff,CL_TRUE,0,N*M*sizeof(TYPE_T),C_fpga);

...
//Channels
//channel float readData;		
//channel float writeData;
...
{
	for (int i = D; i < N-D; ++i) 
    	out[i]=read_channel_intel(systolicChannels[D]);
}


__attribute__((max_global_work_dim(0)))
__attribute__((autorun))
__attribute__((num_compute_units(D,1)))
__kernel void Simple1DStencil()
{
